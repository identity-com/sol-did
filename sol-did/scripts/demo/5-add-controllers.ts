...
const newKeyPrivateKey = [10,131,56,82,11,227,33,197,195,34,181,176,159,28,228,230,64,190,100,109,173,211,128,42,163,157,53,207,11,144,199,61,56,232,119,218,42,110,158,125,114,72,190,173,159,49,99,161,31,109,48,6,193,249,156,45,164,190,37,21,3,126,82,54];
const controllers = [ 'did:sov:CYQLsccvwhMTowprMjGjQ6', DidSolIdentifier.create(Keypair.generate().publicKey, cluster).toString() ];
...
(async () => {
  ...
  const sig = await service.setControllers(controllers)
