...
import {Account, clusterApiUrl, PublicKey as SolanaPublicKey} from '@solana/web3.js';
...
export const extractMethodIdentifierFromDID = (did: string): string => matchDID(did)[2];
...
export const accountAndClusterToDID = (account: Account, cluster:ExtendedCluster = 'mainnet-beta') => {
...
export const solanaUrlForCluster = (cluster: ExtendedCluster) => cluster === 'localnet' ? 'http://localhost:8899' : clusterApiUrl(cluster)
